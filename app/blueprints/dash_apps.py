...
def init_dash_apps(flask_app):
    ...
    # Define df1 with the expected columns
    df1 = pd.DataFrame({
        "Category": ["A", "B", "C"],  # Ensure this column name matches your usage
        "Value": [10, 20, 30]         # Ensure this column name matches your usage
    })
